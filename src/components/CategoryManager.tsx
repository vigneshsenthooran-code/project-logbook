...
export default function CategoryManager() {
  ...
  function remove(id: string) {
    ...
    void setCategories(categories.filter((c) => c.id !== id && c.parentId !== id));
  }
  ...
  function addCategory() {
    ...
    void setCategories([...categories, next]);
  }
        ...
        {tops.map((cat, i) => (
          <div key={cat.id} className="catmgr-item card">
            ...
            <KeywordEditor
              ...
              onChange={(kw) => update(cat.id, { keywords: kw })}
            />
              ...
              {subHeadings(categories, cat.id).map((sub) => (
                <div key={sub.id} className="catmgr-sub">
                  ...
                  <KeywordEditor
                    ...
                    onChange={(kw) => update(sub.id, { keywords: kw })}
                  />
